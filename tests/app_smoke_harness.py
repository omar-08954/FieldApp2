...
fake_db.match_import_technician = lambda value, *_args, **_kwargs: (value, None)
fake_db.normalize_import_task_type = lambda value, *_args, **_kwargs: (value or "تقني")
fake_db.normalize_import_task_status = lambda value, *_args, **_kwargs: (value or "تم الفحص")
